...
<body>
    <fieldset>
        ...
        <form action="introduirmapes.php", name="formulari_mapes" method="post">
            <label for="NMapa">Escriu el nom del teu mapa: <span style="background-color:red;"><?=$msgErrorNMapa?></span></label><input type="text" name="NMapa" placeholder="Nombre de tu mapa" value="<?=$NMapa?>" required><br>
            ...
            <label for="IMapa">URL del Mapa: <span style="background-color:red;"><?=$msgErrorIMapa?></span></label><input type="text" name="mapa" placeholder="url del mapa" value="<?=$IMapa?>" required><br>        
        </fieldset>
